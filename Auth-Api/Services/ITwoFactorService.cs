...
namespace Auth_Api.Services
{
    ...
    public class TwoFactorService : ITwoFactorService
    {
        ...
        public TwoFactorService(AppDbContext context, UserManager<ApplicationUser> userManager, ILogger<AccountService> logger, IRefreshTokenHelper refreshTokenHelper)
        {
